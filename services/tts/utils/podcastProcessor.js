...
async function applyFades(sessionId, introPath, outroPath) {
  ...
  debug ("✅ STEP 1 complete: Fades applied", {
    sessionId,
...
async function applyAudioEffects(
 ...
 info("🎛️ STEP 2: Applying audio effects");
  debug("🎛️ STEP 2: Applying audio effects (concat + compression + loudnorm)", {
    sessionId,
  });
  ...
  info("✅ STEP 2 complete: Audio effects applied")
  debug("✅ STEP 2 complete: Audio effects applied", { sessionId, outputPath });
}
